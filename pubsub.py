...
def read_temp_humd():
    ...
    y = {"temp":float(temperature), "humid":float(humidity)} 

    # parsing JSON string: 
    z = json.loads(json_to_push) 
...
parser.add_argument('--message', default=read_temp_humd(), help="Message to publish. " +
